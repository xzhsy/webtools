...
class Connect(object):
    def __init__(self):
        ...
        #定义请求 历史案件：https://adminweb.simuguindonesia.com/api/api/review/loanAppAssignedHistory?offset=0&limit=10
        self.baseurl='https://adminweb.simuguindonesia.com/api/api/review/loanAppAssignedHistory?'
        self.loadUrl='https://adminweb.simuguindonesia.com/api/api/review/applyHistory?'
        #验证码连接
