...
class Connect(object):
    def __init__(self):
        ...
        #定义请求连接
        self.baseurl='https://adminweb.simuguindonesia.com/api/api/collection/my?'
        self.userUrl='https://adminweb.simuguindonesia.com/api/api/review/personalInfo?'
        self.loadUrl='https://adminweb.simuguindonesia.com/api/api/collection/collection-loan-detail?'
        #验证码连接
