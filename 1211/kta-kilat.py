...
class Connect(object):
    def __init__(self):
        self.headers = {
            "Host": " adminweb.kta-kilat.net",
            "User-Agent": " Mozilla/5.0 (X11; Linux x86_64; rv:60.0) Gecko/20100101 Firefox/60.0",
            "Accept": "*/*",
            "Accept-Language": " zh-CN,zh;q=0.8,zh-TW;q=0.7,zh-HK;q=0.5,en-US;q=0.3,en;q=0.2",
            "Accept-Encoding": " gzip, deflate, br",
            "Referer": "https://adminweb.kta-kilat.net/collection/my",
            "origin": " https://adminweb.kta-kilat.net",
        ...
        #定义请求连接
        #https://adminweb.kta-kilat.net/api/api/collection/my?collectionTaskStatus=CREATED&dueDateFrom=2019-11-15&dueDateTo=2019-12-11&offset=0&limit=10
        self.baseurl='https://adminweb.kta-kilat.net/api/api/collection/my?'
        self.userUrl='https://adminweb.kta-kilat.net/api/api/review/personalInfo?'
        self.loadUrl='https://adminweb.kta-kilat.net/api/api/collection/collection-loan-detail?'
        #验证码连接
        self.catpch='https://adminweb.kta-kilat.net/api/auth/captcha?width=120&height=50&serialId=KY1uqphQ'
        self.login = 'https://adminweb.kta-kilat.net/api/auth/login'
